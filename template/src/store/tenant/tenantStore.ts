      ...
      (set, get) => ({
        ...
        fetchTenantMembers: async (tenantId: string): Promise<void> => {
          ...
          try {
            ...
            setError({ 
              message: error.response?.data?.message || 'Failed to fetch tenant members',
              code: error.response?.data?.code 
            });
          }
        },
        ...
        fetchTenantInvites: async (tenantId: string): Promise<void> => {
          ...
          try {
            ...
            setError({ 
              message: error.response?.data?.message || 'Failed to fetch tenant invites',
              code: error.response?.data?.code 
            });
          }
        },
